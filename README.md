...
ссылке: [prod-team-13-cltnksuj.REDACTED](https://prod-team-13-cltnksuj.REDACTED).

Swagger UI с описанием конечных точек проекта доступен по
ссылке: [prod-team-13-cltnksuj.REDACTED/api/swagger-ui](https://prod-team-13-cltnksuj.REDACTED/api/swagger-ui).
